...
import keyword_based_chatbot
import api_based_chatbot
import multi_lingual_chatbot
import data_analysis_chatbot
import rag_chatbot
...
class MultiApp:
    ...
    def run(self):
        ...
        """, unsafe_allow_html=True)
            ...
            app = option_menu(
                menu_title='Sections',
                options=['Home','Keyword-Based Chatbot','Rule-Based Chatbot','API-Based Chatbot','Analytical-Chatbot','RAG-Chatbot','MultiLingual Chatbot','Voice-Chatbot'],
                default_index=0,
            )
